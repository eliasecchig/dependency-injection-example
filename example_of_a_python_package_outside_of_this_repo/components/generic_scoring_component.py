...
def dummy_scoring_with_artifact(text: str, model_module_path: str, model_file: Input[Artifact]) -> str:
...
dummy_scoring_with_artifact_op = create_component_from_func(
    dummy_scoring_with_artifact
)
